    ...
    return async (req, res, next) => {
        try {
            ...
            if (user.roleId) {
                ...
                const roleRecord = await db_1.default.role.findUnique({
                    where: { id: user.roleId },
                    select: { permissions: true },
                });
                if (roleRecord) {
                    userPermissions = roleRecord.permissions || [];
                }
            }
            ...
            if (userPermissions.length === 0 && user.role) {
                ...
                userPermissions = permissions_1.DefaultRolePermissions[legacyRole] || [];
            }
