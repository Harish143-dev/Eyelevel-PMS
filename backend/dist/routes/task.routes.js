...
router.post('/projects/:id/tasks', (0, permission_middleware_1.checkPermission)(permissions_1.Permission.TASK_CREATE), (0, validate_middleware_1.validate)(task_validator_1.createTaskSchema), task_controller_1.createTask);
...
router.put('/tasks/:id', (0, permission_middleware_1.checkPermission)(permissions_1.Permission.TASK_EDIT), (0, validate_middleware_1.validate)(task_validator_1.updateTaskSchema), task_controller_1.updateTask);
...
router.patch('/tasks/:id/status', (0, permission_middleware_1.checkPermission)(permissions_1.Permission.TASK_EDIT), (0, validate_middleware_1.validate)(task_validator_1.updateStatusSchema), task_controller_1.updateTaskStatus);
...
router.post('/tasks/:id/subtasks', (0, permission_middleware_1.checkPermission)(permissions_1.Permission.TASK_CREATE), (0, validate_middleware_1.validate)(task_validator_1.createSubtaskSchema), task_controller_1.createSubtask);
// Task Dependencies
router.post('/tasks/:id/dependencies', (0, permission_middleware_1.checkPermission)(permissions_1.Permission.TASK_EDIT), (0, validate_middleware_1.validate)(task_validator_1.addDependencySchema), task_controller_1.addDependency);
