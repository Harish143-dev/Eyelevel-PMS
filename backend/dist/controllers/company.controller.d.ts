 ...
 */
export declare const updateCompanyFeatures: (req: AuthRequest, res: Response) => Promise<void>;
/**
 * PATCH /api/companies/:id/status
 * Update a company's status (active, suspended, etc.)
 * Body: { status }
 */
export declare const updateCompanyStatus: (req: AuthRequest, res: Response) => Promise<void>;
/**
 * GET /api/companies/my
 * Get the current user's company with full details.
 */
export declare const getMyCompany: (req: AuthRequest, res: Response) => Promise<void>;
